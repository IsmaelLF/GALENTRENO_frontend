...
const togglePlayback = () => {
  ...
  if (isPlaying.value) {
    desktopVideoRef.value.pause();
    mobileVideoRef.value.pause();
    isPlaying.value = false;
  } else {
    desktopVideoRef.value.play();
    mobileVideoRef.value.play();
    ...
    <div class="w-full h-full relative z-10">
      ...
      <div v-if="currentSlide === 0" class="w-full h-full flex flex-col items-center justify-center relative overflow-hidden animate-in fade-in zoom-in duration-1000">
        ...
        <div class="relative z-10 flex flex-col items-center text-center space-y-10">
          ...
          <div class="space-y-4">
            <h1 class="text-8xl font-black tracking-tighter text-white drop-shadow-lg">GALENTRENO</h1>
          ...
          <div class="mt-16 bg-neutral-900/80 backdrop-blur border border-neutral-800 p-6 rounded-2xl flex items-center gap-5 hover:border-orange-500/50 transition-colors cursor-default shadow-lg">
            <div class="w-14 h-14 rounded-full bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center text-xl font-bold text-white">IL</div>
            <div class="text-left">
      ...
      <div v-if="currentSlide === 5" class="w-full h-full flex flex-col justify-center px-16 max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-3 gap-10 relative items-center">
           ...
           <div :class="[TRANSITION, getStepClass(2)]" class="relative bg-neutral-900 p-10 rounded-[2rem] border-2 border-orange-500 shadow-[0_0_40px_rgba(249,115,22,0.2)] hover:-translate-y-4 hover:shadow-orange-500/40 transition-all group z-20 scale-110">
              ...
              <p class="text-gray-300 text-center text-sm leading-relaxed">Gráficas detalladas de volume, proxección de 1RM e comparativas visuais de rendemento.</p>
           </div>
      ...
      <div v-if="currentSlide === 6" class="w-full h-full flex flex-col items-center justify-center relative bg-black" @click.stop="togglePlayback">
         ...
         <div v-if="currentStep === 0" class="text-center animate-in zoom-in duration-700 relative z-10 px-4">
            ...
            <div class="mt-12 inline-flex items-center gap-2 text-orange-500 border border-orange-500/30 px-6 py-3 rounded-full animate-bounce cursor-pointer hover:bg-orange-500/10 transition-colors" @click.stop="next">
               <span>👇</span>
         ...
         >
            ...
            <div class="relative w-[22%] aspect-[9/19] rounded-[2.5rem] shadow-[0_20px_50px_rgba(234,88,12,0.2)] border-[6px] border-neutral-800 bg-black group transform translate-y-10 hover:-translate-y-2 transition-transform duration-500">
            ...
            <div 
             ...
             >
                <div class="bg-black/60 backdrop-blur-sm p-6 rounded-full border border-white/20 shadow-2xl">
